class Pens::MicroCluster < ApplicationRecord
  has_many :collected_pens, foreign_key: :pens_micro_cluster_id, inverse_of: :pens_micro_cluster
  ...
  scope :ordered, lambda { order(:simplified_brand, :simplified_model, :simplified_color) }
end
